...
export async function createMainWindow() {
  ...
  mainWindow = new BrowserWindow({
    width: 190, // Adjusted width to accommodate smaller speech bubble (180px + 10px margin)
    height: 400, // Increased height for speech bubble (93px Clippy + 40px bubble + 8px spacing + padding)
    transparent: true,
    hasShadow: false,
    frame: false,
